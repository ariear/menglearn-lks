...
window.onload = function() {
    ...
    function render() {
        ...
        context.font = "18px Verdana";
        drawCenterText("Top Score:", 0, 580, 150);
        context.font = "18px Verdana";
        drawCenterText(localStorage.getItem('topScore'), 0, 605, 150);
    ...
    function drawFrame() {
        ...
        drawCenterText("Nama Player : " + localStorage.getItem('nama'), 430, 30, 150);
